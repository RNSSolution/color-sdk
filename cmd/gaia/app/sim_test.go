...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ github.com/ColorPlatform/color-sdk/cmd/gaia/app -bench ^BenchmarkFullGaiaSimulation$ -SimulationCommit=true -cpuprofile cpu.out

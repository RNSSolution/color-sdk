...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ github.com/ColorPlatform/color-sdk/cmd/color/app -bench ^BenchmarkFullGaiaSimulation$ -SimulationCommit=true -cpuprofile cpu.out

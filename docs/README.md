...
- [SDK API Reference](https://godoc.org/github.com/ColorPlatform/color-sdk): Godocs of the Cosmos SDK.
...
See [this file](https://github.com/ColorPlatform/color-sdk/blob/master/docs/DOCS_README.md) for details of the build process and

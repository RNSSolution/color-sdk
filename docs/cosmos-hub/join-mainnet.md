...
For more information on seeds and peers, you can [read this](https://github.com/ColorPlatform/prism/blob/develop/docs/tendermint-core/using-tendermint.md#peers).

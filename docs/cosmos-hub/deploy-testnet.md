...
Supporting code can be found in the [networks directory](https://github.com/RNSSolution/color-sdk/tree/develop/networks) and additionally the `local` or `remote` sub-directories.
...
From the [networks/local directory](https://github.com/RNSSolution/color-sdk/tree/develop/networks/local):
...
The following should be run from the [networks directory](https://github.com/RNSSolution/color-sdk/tree/develop/networks).

...
colorcli tx gov submit-proposal --title "Test Proposal" --description "My awesome proposal" --type <type> --deposit=10000000uclr --fund=10000000000uclr --cycle=1-6  --gas auto --gas-adjustment 1.5 --gas-prices <gasPrice> --from <delegatorKeyName>

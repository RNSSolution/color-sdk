...
CLI Guide 🔗:  [github.com/ColorPlatform/color-sdk/…/delegator-guide-cli.md](https://github.com/ColorPlatform/color-sdk/blob/develop/docs/gaia/delegator-guide-cli.md) 
...
[ibc]: [https://github.com/ColorPlatform/color-sdk/blob/develop/docs/spec/ibc/overview.md]

...
var (
	...
	DefaultMinSignedPerWindow      = sdk.NewDecWithPrec(10, 1)
	DefaultSlashFractionDoubleSign = sdk.NewDec(1).Quo(sdk.NewDec(10))
	DefaultSlashFractionDowntime   = sdk.NewDec(10).Quo(sdk.NewDec(100))
)

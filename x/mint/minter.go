...
type Minter struct {
	...
	WeeklyProvisions sdk.Dec `json:"weekly_provisions"` // current annual expected provisions
}
...
// 	inflationRateChange := inflationRateChangePerYear.Quo(sdk.NewDec(int64(params.BlocksPerWeek)))
...
// func (m Minter) NextWeeklyProvisions(_ Params, totalSupply sdk.Int) sdk.Dec {

...
import (
	...
	clienttx "github.com/RNSSolution/color-sdk/client/tx"
	gapp "github.com/RNSSolution/color-sdk/cmd/gaia/app"
	...
	authrest "github.com/RNSSolution/color-sdk/x/auth/client/rest"
	txbuilder "github.com/RNSSolution/color-sdk/x/auth/client/txbuilder"
	bankrest "github.com/RNSSolution/color-sdk/x/bank/client/rest"
	distr "github.com/RNSSolution/color-sdk/x/distribution"
	distrrest "github.com/RNSSolution/color-sdk/x/distribution/client/rest"
	"github.com/RNSSolution/color-sdk/x/gov"
	govrest "github.com/RNSSolution/color-sdk/x/gov/client/rest"
	gcutils "github.com/RNSSolution/color-sdk/x/gov/client/utils"
	mintrest "github.com/RNSSolution/color-sdk/x/mint/client/rest"
	"github.com/RNSSolution/color-sdk/x/slashing"
	slashingrest "github.com/RNSSolution/color-sdk/x/slashing/client/rest"
	"github.com/RNSSolution/color-sdk/x/staking"
	stakingrest "github.com/RNSSolution/color-sdk/x/staking/client/rest"

	abci "github.com/ColorPlatform/prism/abci/types"
	tmcfg "github.com/ColorPlatform/prism/config"
	...
	tmrpc "github.com/ColorPlatform/prism/rpc/lib/server"
...
func InitializeTestLCD(t *testing.T, nValidators int, initAddrs []sdk.AccAddress, minting bool) (
	...
	for i := 0; i < nValidators; i++ {
		...
		msg := staking.NewMsgCreateValidator(
			...
			sdk.OneInt(), sdk.OneInt(), sdk.OneInt(),
		)

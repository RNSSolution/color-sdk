...
* [\#2935](https://github.com/RNSSolution/color-sdk/issues/2935) Optionally assert invariants on a blockly basis using `gaiad --assert-invariants-blockly`
...
* [\#3917](https://github.com/RNSSolution/color-sdk/issues/3917) Allow arbitrary decreases to validator commission rates.
...
* SDK
  ...
  * [staking] [\#3289](https://github.com/RNSSolution/color-sdk/issues/3289) misc renames:
    * `Validator.UnbondingMinTime` -> `Validator.UnbondingCompletionTime`
    * `Delegation` -> `Value` in `MsgCreateValidator` and `MsgDelegate`
    * `MsgBeginUnbonding` -> `MsgUndelegate`
...
* Gaia
    ...
    * [\#1890](https://github.com/RNSSolution/color-sdk/issues/1890) Start chain with initial state + sequence of transactions
...
* SDK
    ...
    * [x/mint] [\#2531](https://github.com/RNSSolution/color-sdk/issues/2531) Add minting module and inflation logic
...
* Gaia CLI  (`gaiacli`)
  ...
  * [cli] [\#2220](https://github.com/RNSSolution/color-sdk/issues/2220) Add `gaiacli config` feature to interactively create CLI config files to reduce the number of required flags
...
* [\#1258](https://github.com/RNSSolution/color-sdk/issues/1258) - printing big.rat's can no longer overflow int64
* [\#1259](https://github.com/RNSSolution/color-sdk/issues/1259) - fix bug where certain tests that could have a nil pointer in defer
* [\#1343](https://github.com/RNSSolution/color-sdk/issues/1343) - fixed unnecessary parallelism in CI
* [\#1353](https://github.com/RNSSolution/color-sdk/issues/1353) - CLI: Show pool shares fractions in human-readable format
* [\#1367](https://github.com/RNSSolution/color-sdk/issues/1367) - set ChainID in InitChain
* [\#1461](https://github.com/RNSSolution/color-sdk/issues/1461) - CLI tests now no longer reset your local environment data
* [\#1505](https://github.com/RNSSolution/color-sdk/issues/1505) - `gaiacli stake validator` no longer panics if validator doesn't exist
* [\#1565](https://github.com/RNSSolution/color-sdk/issues/1565) - fix cliff validator persisting when validator set shrinks from max
* [\#1287](https://github.com/RNSSolution/color-sdk/issues/1287) - prevent zero power validators at genesis
* [x/stake] fix bug when unbonding/redelegating using `--shares-percent`
* [\#1010](https://github.com/RNSSolution/color-sdk/issues/1010) - two validators can't bond with the same pubkey anymore
...
FIXES
* Fixes consensus fault on testnet - see postmortem [here](https://github.com/RNSSolution/color-sdk/issues/1197#issuecomment-396823021)
